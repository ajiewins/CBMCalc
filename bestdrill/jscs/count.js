...
function ele_aliases(){
  ...
  if (myTemp != myVal){
      ...
      if (myVal=="ne"){
          ...
          mmsg="<font size='6' color='blue'>VERTICAL WELL CASED HOLE COMPLETION WITH<br>HYDRAULIC FRACTURE STIMULATION.</font>\n";
      }
      else if (myVal=="vwwt"){
          mmsg="<font size='6' color='blue'>VERTICAL WELL WITH TOPSET UNDER REAM COMPLETION.</font>\n";
      }
      else if (myVal=="vwwo"){
          mmsg="<font size='6' color='blue'>VERTICAL WELL WITH OPEN HOLE CAVITY COMPLETION or </font>\n";
      }
      else if (myVal=="nstvl"){
          ...
          mmsg="<font size='6' color='blue'>PINNATE OR QUAD LATERAL.</font>\n";
      }
      else if (myVal=="sing"){
          mmsg="<font size='6' color='blue'>SINGLE LATERAL.</font>\n";
      }
          ...
          mmsg="<font size='6' color='blue'>SINGLE STAGE COMPLETION.</font>\n";
      }
      else if (myVal=="msc"){
          mmsg="<font size='6' color='blue'>MULTIPLE STAGE COMPLETION.</font>\n";
      }
      else if (myVal=="aecl"){
          ...
          mmsg="<font size='6' color='blue'>HORIZONTAL WELL WITH LINER.</font>\n";
      }
      else if (myVal=="wellv"){
